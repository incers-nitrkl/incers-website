    ...
    if (window.screen.width <= widths) {
        return (<>
            <div class="top_div PCNavbar-6">
                <div>
                    <div id="logo" style={{ cursor: "pointer" }}><img src="images/logo_new.png" alt='img' style={{ height: "58px", width: "55px", background: "100% 100%", borderRadius: "0px", padding: "2px" }} /></div>
                </div>
                <Navbar />
            </div>
        </>)
                        ...
                        <ul class="row">
                            <li class="col-12 col-md-6 col-lg-3">
                                <div class="cnt-block equal-hight" style={{ height: " 349px" }}>
                                    <figure><img src="images/SIS.jpg"  class="img-responsive" alt="img" /></figure>
                                    <h3>Shivam Sharma </h3>
                                    <p></p>
