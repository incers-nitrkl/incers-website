        ...
        <div className='main_div'>
            ...
            <nav class="navbar fixed-top navbar-expand-lg navbar-dark">
                <div class="container">
                    ...
                    <h3 style={{marginRight:"-53rem"}}>InCerS</h3>
                    <a class="navbar-brand" href="/">
                        <button class="btn btn-primary" style={{marginRight:"-36rem"}}>Home</button>
                    </a>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 mx-auto wow fadeInUp">
                            <h3 class="text-center font-weight-bold">MRIT<span class="bg-main">TIKA</span> SPONSERS 2023</h3>
            ...
            <section class="testimonials bg-light" id="marketplace">
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 mx-auto wow fadeInUp">
                            <h3 class="text-center font-weight-bold">MRIT<span class="bg-main">TIKA</span> SPONSERS 2019</h3>
                            <p class=" text-center">To become a better you, remember to be grateful to people who have contributed to making you who you are today"</p>
                        </div>
                    </div>
                    <div class="row">
